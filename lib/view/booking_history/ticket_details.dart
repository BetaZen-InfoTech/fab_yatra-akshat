                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          "${widget
                                              .myBus["busDetails"]["bus-type"]} /Seater (2+2)",
                                          style: TextStyle(
                                            color: Colors.grey,
                                            fontWeight: FontWeight.w800,
                                            fontSize: 13,
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Text(
                                                    "${widget
                                                        .myBus["busDetails"]["office-contact-person-name"]} - ${widget
                                                        .myBus["busDetails"]["office-contact-person-number"]}",
                                                    style: TextStyle(),
                                                  ),
                                                ),
                                              ),
